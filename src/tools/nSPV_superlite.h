...
char *NSPV_expand_variables(char *bigbuf,char *filestr,char *method)
{
    ...
    NSPV_expand_variable(&bigbuf,&filestr,"$MENU_BUTTON_ARRAY","MENU_BTN_INFO=\"<button class=\"btn btn-info btn-sm\" formaction=\"$URL/method/getinfo?nexturl=info\" formmethod=\"get\">Info</button>\"; MENU_BTN_PEERINFO=\"<button class=\"btn btn-warning btn-sm\" formaction=\"$URL/method/getpeerinfo?nexturl=peerinfo\" formmethod=\"get\">Peer Info</button>\"; MENU_BTN_NEWADDR=\"<button class=\"btn btn-primary btn-sm\" formaction=\"$URL/method/getnewaddress?nexturl=genaddr\" formmethod=\"get\">Generate New Address</button>\"; MENU_BTN_WALLET=\"<button class=\"btn btn-secondary btn-sm\" formaction=\"$URL/method/wallet?nexturl=wallet\" formmethod=\"get\">Transactions</button>\"; MENU_BTN_SEND=\"<button class=\"btn btn-warning btn-sm\" formaction=\"$URL/method/send?nexturl=send\" formmethod=\"get\">Send</button>\"; MENU_BTN_LOGOUT=\"<button class=\"btn btn-danger btn-sm\" formaction=\"$URL/method/logout?nexturl=login\" formmethod=\"get\">Logout</button>\"; MENU_BTN_LOGIN=\"<button class=\"btn btn-success btn-sm\" formaction=\"$URL/method/login?nexturl=login\" formmethod=\"get\">Login</button>\"");
